			...
			<div class="sidebar-menu-inner">
				...
				<div class="slider">
					<div class="fullwidthbanner-container">
						<div class="fullwidthbanner">
							<ul>
								<?php 
							$sel = "SELECT * FROM `slider` WHERE `status` = 1";
							$res = mysqli_query($con, $sel);
								while($data=mysqli_fetch_assoc($res)){ ?>
                         			<li class="first-slide" data-transition="fade" data-slotamount="10" data-masterspeed="300">
									 <img src="admin/image/slider/<?php echo $data['image']; ?>" alt="Profile Picture" style="height: 100%; width:100%; object-fit:cover;">
									...
									<div class="tp-caption second-line lfb tp-resizeme start" data-x="center" data-hoffset="0" data-y="340" data-speed="1000" data-start="800" data-easing="Power4.easeOut" data-splitin="none" data-splitout="none" data-elementdelay="0" data-endelementdelay="0"><?php echo $data['discription']; ?></div>
				...
				<section class="call-to-action-2">
					...
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12">
								<div id="owl-portfolio" class="owl-carousel owl-theme">
									<?php 
									$sel="select * from `blog` order by image DESC LIMIT 8";
         						$res=mysqli_query($con,$sel);
								while($data=mysqli_fetch_assoc($res)){ 
									?>
									<div class="item">
								  		<figure>
				        					<img src="admin/image/blog/<?php echo $data['image']; ?>" alt="Profile Picture" style="height: 100%; width:100%; object-fit:cover;">
				        					<figcaption>
						...
						<div class="owl-navigation">
						  ...
						  <a href="work_3columns.php" class="go-to">Go to portfolio</a>
						</div>
					</div>
				</section>
								...
								while($data=mysqli_fetch_assoc($res)){ 
									...
									<div class="item">
								  		<div class="testimonials-post">
								  			...
								  			<p><?php echo $data['discription']; ?></p>
								  			<h6><?php echo $data['name']; ?>- <em><?php echo $data['city']; ?>,<?php echo $data['country']; ?></em></h6>
								  		</div>
								  </div>
								<?php } ?>
								</div>
				...
				<section class="blog-posts">
					<div class="container">
						...
						<?php 
									$sel="select admin.name , blog.* , category.category from `blog` inner join category on blog.category=category.id inner join admin on blog.author=admin.id order by blog.id desc limit 0,3";
         						$res=mysqli_query($con,$sel);
						...
						<div class="blog-item">
							<div class="col-md-4">
								<a href="single_blog.php?id=<?php echo $id++; ?>"><img src="admin/image/blog/<?php echo $data['image']; ?>" alt="Profile Picture" style="height: 100%; width:100%; object-fit:cover;"></a>
