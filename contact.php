			...
			<div class="sidebar-menu-inner">
				...
				<section class="contact-us">
                    ...
                    <span>enter name...</span>
								...
								<div class="col-md-4 col-sm-4 col-xs-6">
									<input type="email" class="blog-search-field" name="email" placeholder="Your email..." value="" id="email">
                    <span>enter email...</span>

								</div>
								<div class="col-md-4 col-sm-4 col-xs-12">
									<input type="tel" class="contact" name="contact" placeholder="contact..." value="" id="contact">
  ...
  $('#contact_form').submit(function(){
    ...
    if(e_pt.test(email)==false)
    {
      ...
      if (contact.trim() === '' || !contactRegex.test(contact)) {
            $('#contact').next('span').css('display', 'inline').text('Enter a valid Indian contact number (+91 followed by 10 digits)');
            return false;
        } else {
     ...
     if(message=='')
    {
      ...
      $('#message').next('span').css('display','none');
    }
