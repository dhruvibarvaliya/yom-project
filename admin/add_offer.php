...
if (isset($_POST['submit'])) {
    ...
    if (isset($_GET['id'])) {
        $id = $_GET['id'];
        $sql = "UPDATE `offer` SET icon='$icon',title='$title', discription='$discription' WHERE id=$id"; 
    } else {
        $sql = "INSERT INTO `offer` (`icon`,`title`,`discription`) VALUES ('$icon','$title', '$discription')";
    }
...
if (isset($_GET['id'])) {
    $id = $_GET['id'];
    $sel = "SELECT * FROM `offer` WHERE id=$id";
