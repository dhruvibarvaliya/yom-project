...
if(isset($_GET['id'])) {
    $id = $_GET['id'];
        ...
        if ($res) {
            ...
            $check_sql = "SELECT id FROM about WHERE image = '$image' AND id != $id";
            $check_res = mysqli_query($con, $check_sql);
            $num_rows = mysqli_num_rows($check_res);

            if ($num_rows == 0) {
                if(file_exists('image/about/'.$image) && $image != "") {
            ...
            if (mysqli_query($con, $sql)) {
                ...
                echo '<script>alert("this about used in another table so you can not delete it.")</script>';
            }
        } else {
                            ...
                            <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="actions">
                                            <a href="view_about.php?id=<?php echo $data['id']; ?>" class="btn bg-gradient-primary">DELETE</a>
                                            <a href="add_about.php?id=<?php echo $data['id']; ?>" class="btn bg-gradient-danger">EDIT</a>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
